...
import master.realist.REAlistGUIGenerator.shared.dto.EventtypeHasAdditionalattributeDTO;
...
public class EventtypeparticipationHasAdditionalattribute implements
	 ...
	 * 
	 */
	private static final long serialVersionUID = 632803791362791627L;
	...
	/**
	 * Constructor transforming an EventtypeHasAdditionalattributeDTO object to an EventtypeparticipationHasAdditionalattribute object
	 * @param eventtypehasadditionalattributedto
	 */
	public EventtypeparticipationHasAdditionalattribute(EventtypeParticipationHasAdditionalAttributeDTO eventtypehasadditionalattributedto){
		
		this.id = new EventtypeparticipationHasAdditionalattributeId(eventtypehasadditionalattributedto.getEventtypeId(),
						eventtypehasadditionalattributedto.getAgenttypeId(), eventtypehasadditionalattributedto.getAttribute().getId());
		this.attribute = new Attribute(eventtypehasadditionalattributedto.getAttribute());
		this.isOptional = eventtypehasadditionalattributedto.isOptional();
		this.isPolicyProperty = eventtypehasadditionalattributedto.isPolicyProperty();
		this.isReserveProperty = eventtypehasadditionalattributedto.isReserveProperty();
	}
