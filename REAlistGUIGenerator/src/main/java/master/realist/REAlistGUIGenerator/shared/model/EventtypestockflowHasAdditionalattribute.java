...
public class EventtypestockflowHasAdditionalattribute implements
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3800834071353048749L;
	...
	public EventtypestockflowHasAdditionalattribute(EventtypeStockflowHasAdditionalAttributeDTO dto){
		
		this.id = new EventtypestockflowHasAdditionalattributeId(dto.getEventtypeId(),dto.getResourcetypeId(), dto.getAttribute().getId());
		this.attribute = new Attribute(dto.getAttribute());
		this.isOptional = dto.isOptional();
		this.isPolicyProperty = dto.isPolicyProperty();
		this.isReserveProperty = dto.isReserveProperty();
	}
